...
/**
 * Gets the operands (the numbers) and the operator (plus, minus etc) directly from the
 * dom, and returns the correct answer.
 */
function calculateCorrectAnswer() {
    ...
    if (operator === "+") {
        ...
        throw `unimplemented operatoe ${operator}`;
    }
